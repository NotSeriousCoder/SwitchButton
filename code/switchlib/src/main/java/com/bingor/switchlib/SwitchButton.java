...
public class SwitchButton extends CompoundButton {
    ...
    private void setup() {
        ...
        mBackRectF.set(backLeft, mThumbRectF.top - mThumbMargin.top, backLeft + mThumbMargin.left + mThumbSizeF.x
                * mBackMeasureRatio + mThumbMargin.right, mThumbRectF.bottom + mThumbMargin.bottom);
        ...
        if (mBackDrawable != null) {
            mBackDrawable.setBounds((int) mBackRectF.left, (int) mBackRectF.top, (int) mBackRectF.right,
    ...
    public void setChecked(boolean checked) {
        ...
        if (mChangedListener != null) {
            mChangedListener.onStateChanged(checked);
        }
        super.setChecked(checked);
    }

    public void setCheckedNotNotify(boolean checked) {
        // animate before super.setChecked() become user may call setChecked
        // again in OnCheckedChangedListener
        if (isChecked() != checked) {
            animateToState(checked);
    ...
    public void setCheckedNotNotify(boolean checked, boolean needAnim) {
        if (needAnim) {
            setCheckedNotNotify(checked);
        } else {
            if (checked) {
                setProcess(1);
            } else {
    ...
    public OnStateChangedListener getChangedListener() {
